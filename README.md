...
- in a terminal window, navigate to the folder where you downloaded this repo and run `docker-compose up` to build 
- and start the PostgreSQL container - we will interact with it from Spark
